    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                value = startTime ?: "", // Garante que não seja nulo
                onValueChange = {
                    onEvent(AddEditEvent.StartTimeChanged(it))
                },
                placeholder = {
                    Text(text = "Horário de início")
                }
            )
            ...
            OutlinedTextField(
                modifier = Modifier.fillMaxWidth(),
                value = endTime ?: "", // Garante que não seja nulo
                onValueChange = {
                    onEvent(AddEditEvent.EndTimeChanged(it))
                },
                placeholder = {
                    Text(text = "Horário de término")
                }
            )
